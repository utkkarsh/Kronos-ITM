...
$(document).ready(function () {
	...
	var animSpd = 550; // Change also in CSS
	...
	// Generating slides
	var arrCities = ['KNOWLEDGE', 'REFRESHED', 'OPTIMISTIC', 'NOVATURIENT', 'OPPORTUNITY','STUPENDOUS']; // Change number of slides in CSS also
	var numOfCities = arrCities.length;
	var arrCitiesDivided = [];

	arrCities.map(function (city) {
		var length = city.length;
		var letters = Math.floor(length / 3);
